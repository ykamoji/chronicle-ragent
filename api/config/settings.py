...
class AppSettings:
    ...
    def _load(self):
        """Load modelList from disk and default active model to gemma-4-31b-it."""
        try:
        ...
        # Default to gemma-4-31b-it (the model the codebase was using)
        default = next(
            (m for m in self._model_list if m["model"] == "gemma-4-31b-it"),
